#!/usr/bin/env python3
"""Apply manual batch 01 enrichment and storyline for ten EWCA Civ 2024 judgments."""
...
from ewca_civ_2024_batch_01_cases import CASES

ROOT = Path(__file__).parent
BATCH_FILE = ROOT / "storyline_batches" / "ewca_civ_2024_batch_01.json"
ENRICHMENT_MANIFEST = ROOT / "enrichment_manifest.json"
STORYLINE_MANIFEST = ROOT / "storyline_manifest.json"

BATCH_NUMBER = 1
BATCH_DATE = "2026-07-07"
NOTES = "Manual batch 01 enrichment and storyline, 2026-07-07."
